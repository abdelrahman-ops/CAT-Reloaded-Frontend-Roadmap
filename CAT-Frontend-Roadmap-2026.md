# 🚀 CAT Reloaded Frontend Roadmap 2026

> **"Code is easy. Discipline is hard."**

This is the **Master Directory** for the 2026 Bootcamp.
The curriculum is divided into 3 distinct phases.

---

## 🏛️ **Phase 1: The Foundation**
*HTML, CSS, Git, and Building Static Pages.*

*   📘 **[View Phase 1 Roadmap](./roadmap-01-foundation.md)**
    *   *Includes: Web Concepts, Weekly Schedule, and Template Projects.*

---

## ⚙️ **Phase 2: Core Engineering**
*JavaScript, Algorithms, DOM, API, and Tooling.*

*   🚧 **[View Phase 2 Roadmap](./roadmap-02-core.md)**
    *   *Includes: 13-Week JS Schedule, LeetCode Drills, and Capstone Specs.*

---

## 🛤️ **Phase 3: Specialization**
*Choose your framework and master the ecosystem.*
